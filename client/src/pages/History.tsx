...
const filters = [
  ...
  { id: "seculo-xix", label: "Século XIX" },
  { id: "seculo-xx", label: "Século XX" },
  { id: "seculo-xxi", label: "Século XXI" },
];
    ...
    <Layout>
      ...
      <Section>
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="text-3xl font-serif font-bold text-primary mb-4">Nossa Jornada</h2>
          <p className="text-muted-foreground text-lg">
            Uma viagem através dos séculos que moldaram a história do Rio da Casca. 
            Das usinas pioneiras ao santuário de elefantes, cada época deixou sua marca.
          </p>
        </div>
